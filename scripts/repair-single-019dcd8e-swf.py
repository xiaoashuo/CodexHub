...
target_id = "019dcd8e-224b-7561-9381-32ccffed7d8a"
...
backup_dir = codex / "ai-router-workspace" / "backup" / "sessions" / f"manual-single-restore-019dcd8e-swf-{now}"
...
if not rollout.exists():
    # fallback: search by id under sessions.
